...
#计算起始的UTC时间
utcbegintime = (datetime.datetime.now()-datetime.timedelta(hours=3)).strftime("%Y-%m-%dT%H:%MZ")
utcendtime = (datetime.datetime.now() - datetime.timedelta(hours=1)).strftime("%Y-%m-%dT%H:%MZ")
